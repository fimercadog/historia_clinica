        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="txt_especialidad" placeholder="Ingrese la especialidad"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    ...
                    <label for="">Nombre</label>
                    <input type="text" id="txt_especialidad_actual_editar" placeholder="Ingrese la especialidad"
                        maxlength="50" onkeypress="return soloLetras(event)" hidden>
                    <input type="text" class="form-control" id="txt_especialidad_nueva_editar"
                        placeholder="Ingrese la especialidad" maxlength="50" onkeypress="return soloLetras(event)"><br>
                </div>
                <div class="col-lg-12">
                    <label for="">Estatus</label>
