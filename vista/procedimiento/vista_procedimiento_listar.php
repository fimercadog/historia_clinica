        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" id="txt_procedimiento"
                        placeholder="Ingrese procedimiento medico"><br>
                </div>
                <div class="col-lg-12">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-lg-12">
                    ...
                    <label for="">Nombre</label>
                    <input type="text" id="txt_procedimiento_actual_editar" placeholder="Ingrese procedimiento medico"
                        hidden>
                    <input type="text" class="form-control" id="txt_procedimiento_nuevo_editar"
                        placeholder="Ingrese procedimiento medico"><br>
                </div>
                <div class="col-lg-12">
                    <label for="">Estatus</label>
